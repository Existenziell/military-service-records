    ...
    <div>
      ...
      {overlayShown &&
        <div className='flex items-center justify-center text-center'>
          ...
          {/* Overlay */}
          <div className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 rounded-xl bg-white text-brand w-full md:max-w-2xl p-6'>
            ...
            <button onClick={requestAccount} className='button flex items-center justify-between divide-x divide-dashed divide-white max-w-max mx-auto'>
